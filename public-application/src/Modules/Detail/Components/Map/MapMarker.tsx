      ...
      <Popup>
        <div className="w-[400px] flex items-start gap-x-4">
          <div className="flex-1">
            <h6 className="text font-medium">{CATEGORY_DICTIONARY[data.type as keyof typeof CATEGORY_DICTIONARY]}</h6>
            <h5 className="font-bold mt-1 text-xl">{data.name}</h5>
            <address className="line-clamp-3 mt-2">{data.address}</address>
